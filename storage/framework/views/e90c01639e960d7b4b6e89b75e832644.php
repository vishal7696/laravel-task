...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Manifest'); ?> · Shopify CSV Import</title>
    ...
    <div class="min-h-screen flex flex-col">
        <header class="border-b border-white/5 bg-deck/60 backdrop-blur">
            <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
                <a href="<?php echo e(route('dashboard.index')); ?>" class="flex items-center gap-3">
                ...
                <nav class="flex items-center gap-1 text-sm">
                    <a href="<?php echo e(route('dashboard.index')); ?>" class="px-3 py-1.5 rounded-md <?php echo e(request()->routeIs('dashboard.index') ? 'bg-plate text-slate-100' : 'text-slate-400 hover:text-slate-200'); ?>">Uploads</a>
                    <a href="<?php echo e(route('dashboard.logs')); ?>" class="px-3 py-1.5 rounded-md <?php echo e(request()->routeIs('dashboard.logs') ? 'bg-plate text-slate-100' : 'text-slate-400 hover:text-slate-200'); ?>">Event log</a>
                    <a href="<?php echo e(route('uploads.create')); ?>" class="ml-2 px-3 py-1.5 rounded-md bg-manifest text-hull font-medium hover:bg-manifest/90">New upload</a>
                </nav>
            </div>
        </header>
...
<?php /**PATH /home/vishal/ibt/laravel-project-task/new/resources/views/layouts/app.blade.php ENDPATH**/ ?>